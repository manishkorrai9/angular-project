...
export class NotificationsService
{
    ...
    markAllAsRead(): Observable<boolean>
    {
      ...
      /** Establishes one way Signal R communication with API */
  initiateSignalRConnection(){
    this.hubConnection = new SignalR.HubConnectionBuilder()
      .withUrl(`${environment.apiURL}appnotifications`, {
    ...
    this.hubConnection.start()
      ...
      .catch((e) => {
        console.error("==error in signal R connection");
        console.error(e);
      });
  }

  addSignalRDataListner(connectionName,event){
    this.hubConnection.on(connectionName, event);
  }
}
