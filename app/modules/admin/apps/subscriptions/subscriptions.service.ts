...
export class SubscriptionsService
{
     ...
     * Constructor
     */
    constructor(private _httpClient: HttpClient, private httpService: APIService)
    {
    }
    ...
    getServiceCategoriesList() {
        return this.httpService.getAll("api/User/GetMasterData?mastercategoryid=3");
    }

    getServicesList(serviceId: number) {
        return this.httpService.getAll(`api/Subscription/GetSubscriptionList?subscriptionTypeId=${serviceId}`);
    }
}
